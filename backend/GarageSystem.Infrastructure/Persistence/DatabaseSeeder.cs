...
public class DatabaseSeeder
{
    ...
    [
        ...
        new()
        {
            ...
            Wilaya     = Wilaya.Oran,
            DateNaissance = new DateTime(1990, 7, 15),
            IsActif    = true,
            DateCreation = DateTime.UtcNow,
        },
        new()
        ...
        new()
        {
            ...
            DateNaissance = new DateTime(1995, 2, 28),
            IsActif    = true,
            DateCreation = DateTime.UtcNow,
        },
        new()
    ...
    private static List<Vehicule> SeedVehicules(List<Client> clients)
    {
        ...
        [
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2025, 11, 15),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2026, 1, 10),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2025, 9, 3),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2025, 12, 20),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2026, 2, 5),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                DateDernièreVisite     = new DateTime(2026, 3, 18),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
            new()
            {
                ...
                KilométrageDernièreVisite = 90_000,
                DateDernièreVisite     = new DateTime(2025, 8, 22),
                IsActif                = true,
                DateCreation           = DateTime.UtcNow,
            },
        ];
    ...
    [
        new()
        {
            Nom            = "Khaldi",
            Prénom         = "Rachid",
            DateNaissance  = new DateTime(1982, 6, 10),
            ...
            DateEmbauche   = new DateTime(2019, 4, 1),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            Nom            = "Amrani",
            Prénom         = "Sofiane",
            DateNaissance  = new DateTime(1990, 9, 25),
            ...
            SalaireBase    = 58_000,
            TypeContrat    = TypeContrat.CDI,
            DateEmbauche   = new DateTime(2021, 9, 15),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            Nom            = "Ouali",
            Prénom         = "Nadia",
            DateNaissance  = new DateTime(1993, 3, 8),
            ...
            SalaireBase    = 48_000,
            TypeContrat    = TypeContrat.CDI,
            DateEmbauche   = new DateTime(2022, 2, 1),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            Nom            = "Ferhat",
            Prénom         = "Yacine",
            DateNaissance  = new DateTime(1987, 12, 17),
            ...
            SalaireBase    = 52_000,
            TypeContrat    = TypeContrat.CDI,
            DateEmbauche   = new DateTime(2020, 7, 1),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            ...
            SalaireBase    = 60_000,
            TypeContrat    = TypeContrat.CDI,
            DateEmbauche   = new DateTime(2018, 1, 15),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            Nom            = "Kaci",
            Prénom         = "Lounès",
            DateNaissance  = new DateTime(1998, 8, 30),
            ...
            DateEmbauche   = new DateTime(2025, 1, 1),
            DateFinContrat = new DateTime(2026, 12, 31),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
        new()
        {
            Nom            = "Mezrag",
            Prénom         = "Amel",
            DateNaissance  = new DateTime(1991, 4, 14),
            ...
            SalaireBase    = 80_000,
            TypeContrat    = TypeContrat.CDI,
            DateEmbauche   = new DateTime(2017, 6, 1),
            IsActif        = true,
            DateCreation   = DateTime.UtcNow,
        },
    ];
